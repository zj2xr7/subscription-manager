...
export const api = {
  ...
  pendingPurchases: () => request('/bank-card/purchases?status=pending'),
  createPurchase: data => request('/bank-card/purchases', { method: 'POST', body: JSON.stringify(data) }),
  updatePurchase: (id, data) => request(`/bank-card/purchases/${id}`, { method: 'PUT', body: JSON.stringify(data) }),
  deletePurchase: id => request(`/bank-card/purchases/${id}`, { method: 'DELETE' }),
  createTransfer: data => request('/bank-card/transfers', { method: 'POST', body: JSON.stringify(data) }),
  deleteTransfer: id => request(`/bank-card/transfers/${id}`, { method: 'DELETE' }),
